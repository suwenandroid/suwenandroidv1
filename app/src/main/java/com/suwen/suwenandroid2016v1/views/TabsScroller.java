...
public class TabsScroller extends HorizontalScrollView {
    ...
    private int tabTextColor = 0x666666;// 标题未被选中时字体颜色
    ...
    private void setPositionSelected(int position) {
        ...
        if (tabsContainer != null) {
            for (int i = 0; i < tabsContainer.getChildCount(); i++) {
                ...
                if (i == position) {
                    tv.setTextColor(tabTextColorSelected);
                } else {
